...
def clone_ind(ind, icls, scls):
    """Clones an individual, does the same as toolbox.clone"""
...
def varOr(population, toolbox, parents, lambda_, cxpb, mutpb, *clone_args):
    ...
    for _ in range(lambda_):
        ...
        if op_choice < cxpb:            # Apply crossover
            ...
            # toolbox.clone doesn't make a new instance? Why?
            # ==> Actually yes it does
            # ancestor = clone_ind(ind1, *clone_args) # Useless


            ### TEST REMOVE ME: Test OK with clone_ind and test OK with toolbox.clone
            ...
            # ancestor = clone_ind(ind, *clone_args) # Useless
            ...
            ### TEST REMOVE ME: The test passes! and test OK with toolbox.clone
            # ancestor.curiosity = 666.0
            # assert ind.curiosity != 666.0
            ### END TEST
